  ...
  return (
    <View style={styles.player_stat}>
      ...
      <View style={styles.stat_container}>
        <IconButton icon="minus" style={styles.icon} onPress={decrease} />
        <TextInput
          mode="outlined"
          textColor={
            isHp && value <= Math.floor(maxValue / 2.0)
              ? theme.colors.error
        ...
        />
        <IconButton icon="plus" style={styles.icon} onPress={increase} />
      </View>
      <View>
        <TouchableOpacity
          style={{
          ...
          <Text style={{ fontSize: 10 }}>
            <Text style={styles.bold_text}>MAX:</Text>
            {maxValue}
          </Text>
        </TouchableOpacity>
      </View>
