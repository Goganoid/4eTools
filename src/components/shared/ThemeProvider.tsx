...
const darkTheme = {
  ...
  colors: {
    text: '#ffff',
    primary: 'rgb(255, 171, 243)',
    onPrimary: 'rgb(91, 0, 91)',
    primaryContainer: 'rgb(129, 1, 129)',
    onPrimaryContainer: 'rgb(255, 215, 245)',
    secondary: 'rgb(253, 171, 245)',
    onSecondary: 'rgb(84, 19, 84)',
    secondaryContainer: 'rgb(110, 44, 109)',
    onSecondaryContainer: 'rgb(255, 215, 247)',
...
export const CustomThemeProvider = ({
  ...
  return (
    <Provider theme={isDarkMode ? darkTheme : lightTheme}>{children}</Provider>
  );
};
